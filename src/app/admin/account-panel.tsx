...
/**
 * Cambio de contraseña para la cuenta de superadmin. Reusa la misma server action que "Mi cuenta"
 * del panel de clínica (`changeOwnPassword` solo exige sesión válida, no membresía), porque la
 * cuenta de plataforma no puede entrar a /configuracion: no pertenece a ninguna clínica.
 */
export function AdminAccountPanel() {
  ...
  return (
    <section className="max-w-md rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="flex items-center gap-3 border-b border-slate-100 p-5">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500">Cambiá la contraseña de acceso del superadmin</p>
        </div>
      </div>
